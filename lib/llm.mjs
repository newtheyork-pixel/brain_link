...
/**
// The instant-speech map lives in ONE place: data/profile.json, served to the client via
// /api/health. A duplicate hardcoded here had already drifted out of sync (it was missing six
// urgent tiles), so it is deleted rather than left to rot into a second source of truth.
